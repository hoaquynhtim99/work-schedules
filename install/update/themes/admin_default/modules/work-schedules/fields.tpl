    ...
    <table class="table table-striped table-bordered table-hover">
        <thead>
            <tr class="text-center">
                <th class="100">{LANG.order}</th>
                <th>{LANG.field_id}</th>
                <th>{LANG.field_title}</th>
                <th>{LANG.field_type}</th>
                <th>{LANG.field_show_addedit}</th>
                <th>{LANG.field_required}</th>
                <th>{LANG.field_show_manager}</th>
                <th class="w150">&nbsp;</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><i class="fa fa-lg {ROW.show_addedit}" aria-hidden="true"></i></td>
                <td class="text-center"><i class="fa fa-lg {ROW.required}" aria-hidden="true"></i></td>
                <td class="text-center"><i class="fa fa-lg {ROW.show_manager}" aria-hidden="true"></i></td>
                <td class="text-center">
                    <a class="btn btn-xs btn-default" href="javascript:void(0);" onclick="nv_edit_field({ROW.fid});" title="{LANG.field_edit}"><i class="fa fa-edit"></i> {LANG.field_edit}</a>
                    <a class="btn btn-xs btn-danger" href="javascript:void(0);" onclick="nv_del_field({ROW.fid})" title="{GLANG.delete}"><i class="fa fa-trash"></i> {GLANG.delete}</a>
                </td>
            </tr>
            <!-- END: loop -->
        </tbody>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-control required w150" type="text" value="{DATAFORM.field}" name="field" {DATAFORM.fielddisabled}>
                        <span class="help-block help-block-no">{LANG.field_id_note}</span>
                    </td>
                </tr>
                <!-- END: field -->
                <tr>
                ...
                <tr>
                    ...
                    <td><textarea cols="60" rows="3" name="description" class="form-control w350">{DATAFORM.description}</textarea></td>
                </tr>
                <tr>
                    <td>{LANG.field_required}</td>
                    <td><input name="required" value="1" type="checkbox" {DATAFORM.required}> <span class="help-block help-block-no display-inline-block">{LANG.field_required_note}</span></td>
                </tr>
                <tr>
                    <td>{LANG.field_show_addedit}</td>
                    <td><input name="show_addedit" value="1" type="checkbox" {DATAFORM.show_addedit}></td>
                </tr>
                <tr>
                    <td>{LANG.field_show_website}</td>
                    <td><input name="show_website" value="1" type="checkbox" {DATAFORM.show_website}/></td>
                </tr>
                <tr>
                    <td>{LANG.field_show_manager}</td>
                    <td><input name="show_manager" value="1" type="checkbox" {DATAFORM.show_manager}></td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <span class="help-block help-block-no">{LANG.field_type_note}</span>
                        <!-- END: field_type -->
                        {FIELD_TYPE_TEXT}
                    </td>
                </tr>
